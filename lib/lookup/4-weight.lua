...
stage.weight = function()
    ...
    -- TODO: Deal with possible different rocket lift weights
            ...
            if weight[item.name] == nil then
                ...
                if next(valid_recipes) == nil then
                    ...
                    local function category_order(recipe)
                        -- TODO: Fix once I learn about how categories are ordered now that they're arrays (the docs seem outdated)
                        ...
                        return ""
                        -- TODO: Apparently the docs may just be botched on this entirely, and it probably just goes group --> subgroup --> order --> name
                    end
