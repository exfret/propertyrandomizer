...
def solve_moment_growth_lp(
    ...
    v28 keeps the fixed-copy technology timing and uses direct zero-objective
    ...
    if solve_mode == 'maximize':
        ...
        # By default v28 solves this LP directly; explicit Phase-I remains an
    ...
    # Optional explicit Phase-I diagnostics.  v28 defaults to solving the
    ...
    if save_lp_dir is not None:
        ...
        (save_lp_dir / 'lp-metadata.json').write_text(
            json.dumps(_json_safe({
                'format': 'propertyrandomizer-moment-growth-lp-v28-pre-solve',
    ...
    output: dict[str, Any] = {
        ...
        'ordering_search': {
            ...
            'note': (
                ...
                + 'Any validated feasible solution overrides infeasible/positive-Phase-I reports from other orderings. '
            ...
            (
                {
                    ...
                    'note': (
                        'v28 default: solve the original feasibility LP directly. '
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "tests whether --goal-amount is reachable; v28 defaults to a direct zero-objective "
    ...
    parser.add_argument(
        ...
        default="direct",
        help=(
            "Feasibility strategy. direct (default in v28) solves the original LP with zero "
