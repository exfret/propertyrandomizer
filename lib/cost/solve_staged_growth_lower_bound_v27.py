...
In addition to Hausdorff consistency of each action-moment sequence q_k, v27
...
v27 additionally treats synthetic conserved AND outputs, recipe-category,
...
def solve_moment_growth_lp(
    ...
    v27 keeps the fixed-copy technology timing and global-slack
...
def main() -> None:
    ...
    result.update(
        {
            "format": "propertyrandomizer-moment-growth-lp-v27",
