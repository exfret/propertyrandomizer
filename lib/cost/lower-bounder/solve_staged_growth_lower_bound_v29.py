...
def solve_moment_growth_lp(
    ...
    certificate_time_limit: float = 60.0,
) -> dict[str, Any]:
    ...
    v29 keeps the fixed-copy technology timing and uses direct zero-objective
    ...
    # Optional explicit Phase-I diagnostics.  v29 defaults to solving the
    ...
    if save_lp_dir is not None:
        ...
        (save_lp_dir / 'lp-metadata.json').write_text(
            json.dumps(_json_safe({
                'format': 'propertyrandomizer-moment-growth-lp-v29-pre-solve',
    ...
    if certificate_time_limit <= 0.0:
        raise ValueError('--certificate-time-limit must be > 0')
    ...
    output: dict[str, Any] = {
        ...
        'infeasibility_certificate': {
            ...
            'note': (
                'On a direct HiGHS infeasible report, v29 can re-solve that ordering with highspy, '
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "tests whether --goal-amount is reachable; v29 defaults to a direct zero-objective "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Disable the v29 highspy Farkas-certificate check after a direct HiGHS "
    ...
    parser.add_argument(
        ...
        default=60.0,
        help=(
            "Time limit in seconds for the highspy certificate re-solve "
            "after SciPy/HiGHS reports infeasible (default 60)."
        ),
    )
    parser.add_argument(
        "--phase1-tolerance",
    ...
    parser.add_argument(
        ...
        default="direct",
        help=(
            "Feasibility strategy. direct (default in v29) solves the original LP with zero "
    ...
    result.update(
        {
            "format": "propertyrandomizer-moment-growth-lp-v29",
