...
local function load()
    ...
    -- TODO: This needs to have -surface at the end to align with conventions
    ...
    -- TODO: Some node names don't follow convention and so aren't converted correctly (I think?)
...
build_graph.ops = {
    ...
    ["character"] = "OR",
    -- TODO: Remove the following? Simultaneous randomization is no longer a thing and has been replaced by unified rando
