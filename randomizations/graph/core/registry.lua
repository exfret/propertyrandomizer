...
export.const = {
    unused_preferred = "unused",
    reachable_preferred = "reachable",
}
...
export.create_empty_randomizer = function (key)
    return {
        ...
        config = {
            preferred_edges = const.config_unused,
        },
        ...
        -- Optional, called directly after each dependent has been unlocked.
        -- Update randomizer internal state perhaps?
        on_assign_prereqs_success = function (state) end,
